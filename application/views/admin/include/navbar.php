    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li><a href="https://codecanyon.net/item/codeigniter-with-adminlte-integration-user-crud/20752434?ref=codeglamour" class="btn-danger"><i class="fa fa-download"></i>&nbsp; Buy Now</a></li>

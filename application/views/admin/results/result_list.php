            ...
            <table id="example1" class="table table-bordered table-striped ">
                ...
                <?php foreach($all_results as $row): ?>
                    <tr>
                        ...
                        <td><?= $row['drawdate']; ?></td>
                        <td><?= $row['result']; ?></td>
                        <td class="text-right"><a href="<?= base_url('admin/results/edit/'.$row['id']); ?>" class="btn btn-info btn-flat btn-xs">Edit</a>
                            <a data-href="<?= base_url('admin/results/del/'.$row['id']); ?>" class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#confirm-delete">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
